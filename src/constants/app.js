...
export const registryAddress =
  process.env.REACT_APP_RNS_REGISTRY_CONTRACT_ADDRESS;
export const tokenNetworkAddresses = getListFromString(
  process.env.REACT_APP_TOKEN_NETWORK_ADDRESSES
);
export const notifierEndpoints = getListFromString(
  process.env.REACT_APP_NOTIFIER_ENDPOINTS
);
